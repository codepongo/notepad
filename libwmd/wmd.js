...
Attacklab.wmdBase = function(){
	...
	util.createImage = function(img){
		...
		elem.className = "wmd-button fa fa-";
		elem.src = imgPath;
	...
	wmd.editor = function(previewRefreshCallback){
		...
		var makeSpritedButtonRow = function(){
			...
			boldButton.className = "wmd-button fa fa-bold fa-1";
      ...
      boldButton.XShift = "0px";
			...
			italicButton.className = "wmd-button fa fa-italic";
			...
			linkButton.className = "wmd-button fa fa-link";
			...
			quoteButton.className = "wmd-button fa fa-quote-left";
			...
			codeButton.className = "wmd-button fa fa-code";
			...
			imageButton.className = "wmd-button fa fa-image";
			...
			olistButton.className = "wmd-button fa fa-list-ol";
			...
			ulistButton.className = "wmd-button fa fa-list";
			...
			headingButton.className = "wmd-button fa fa-header";
			...
			hrButton.className = "wmd-button fa fa-minus";
			...
			undoButton.className = "wmd-button fa fa-undo";
			...
			redoButton.className = "wmd-button fa fa-repeat";
